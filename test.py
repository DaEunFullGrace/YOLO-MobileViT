...
def test(data,
         ...
         ms_infer=False):   # multi-scale inference
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            inf_out, train_out = model(img, 
                                        ...
                                        ms_infer=ms_infer, 
                                        verbose=verbose, 
                                        scale_f=1.6)  # inference and training outputs
            # print(inf_out.shape)
            # inf out : 8, 4860, 6
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ms-infer', action='store_true', help='multi-scale inference') # ms inference
    parser.set_defaults(ms_infer=False)
